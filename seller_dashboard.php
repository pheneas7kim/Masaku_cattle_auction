...
$stmt = $conn->prepare("INSERT INTO cattle (seller_id, name, breed, age, price, phone,weight, image, status) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?,'pending')");
//$stmt->bind_param("issidds", $seller_id, $name, $breed, $age, $price,$phone, $weight, $imageName);
$stmt->bind_param("issidids", $seller_id, $name, $breed, $age, $price, $phone, $weight, $imageName);
...
<body>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <input type="text" step="1" name="weight" required><br><br>

        <label>price (ksh):</label><br>
        <input type="text"  name="price" required><br><br>

         <label>phone :</label><br>
        <input type="text"  name="phone" required placeholder ="0700000000"><br><br>
  ...
  <tr>
    ...
    <td><img src="uploads/<?php echo $row['image']; ?>" width="80" height="60"></td>
    
    <td>
      <a href="edit_cattle.php?id=<?php echo $row['id']; ?>">Edit</a> 
